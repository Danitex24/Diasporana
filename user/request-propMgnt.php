...
$activities=$row['firstName']." ".$row['lastName']." "."has requested to buy a freshland"." ".$urow['name'];
$stmt = "INSERT INTO package (propID, userID, email, phone, name, propName, subscribed, subscribeDate) VALUES (?, ?, ?, ?, ?,?, ?, ?)";
$stmt = $conn->prepare($stmt);
$stmt->bind_param("isssssss", $landID, $userID, $contactEmail, $contactNo, $name, $propName,  $purpose,$requestDate);
$stmt->execute();
                                       ...
                                       <center><h6>Request management on this property</h6></center>
                                        <div class="form-group">
                                            <form class="form-control" method="POST" action="">
                                                ...
                                                <input type="text" name="name" class="form-control" value="<?php echo $urow['name'] ?>"readonly="yes">
