...
userID, propID, subject, content, status, image, image1, image2, image3, image4, addDate
$addreprt="INSERT INTO `report` (`userID`, `propID`, `subject`, `content`, `status`, `image`, `image1`, `image2`, `image3`, `image4`, `addDate`) VALUES ('$userID', '$propID', '$subject', '$content', '$status','$image', '$image1', '$image2', '$image3', '$image4', '$addDate')";
    if (mysqli_query($conn,$addreport) ){

echo"<script>alert('Report sent successfully')
    ...
    echo "<div class='alert alert-danger'> Sorry, there was an error sending report</div>";
    unlink("images/".$landImage);
    unlink("images/".$image1);
    unlink("images/".$image2);
    unlink("images/".$image3);
