...
INSERT INTO `freshland` (`id`, `landSize`, `title`, `purpose`, `location`, `price`, `landImage`, `image1`, `image2`, `image3`, `image4`, `description`, `status`, `addBy`, `addedDate`, `approveDate`) VALUES
(1, '501.10  Hectares', 'C of O (Certificate of Occupancy)', 'Mass Housing', 'Gude, FCT-Abuja', 'Fifteen Billion Naira (N15, 000,000,000.00) only.', '15.jpg', '1.jpg', '2.jpg', '3.jpg', '4.jpg', 'Very easy to locate and  quick acces to the road', 'Approved', '', 'December-09-2020 14: 15: ', 'December/21/2020 13: 57: ');
...
(42, 'Diasporana-468575239', '', '1', '421288829', '#471453846', '1', '', '', 'C of O (Certificate of Occupancy)', '', 'Fifteen Billion Naira (N15, 000,000,000.00) only.', 'Gude, FCT-Abuja', 'Sent for approval', '', '', '', '', '', 'Salamat Group Ltd.', '5th Floor, Merit House, Plot 22, Aguiyi Ironsi Street, Maitama, Abuja.', '07025004795', '', '', 'December/21/2020 10: 19: 22:'),
...
INSERT INTO `landrequest` (`id`, `userID`, `landID`, `title`, `price`, `purpose`, `contactNo`, `email`, `status`, `requestDate`, `approveDate`) VALUES
(19, 'Diasporana-468575239', '1', 'C of O (Certificate of Occupancy)', 'Fifteen Billion Naira (N15, 000,000,000.00) only.', 'Mass Housing', '080000000033', 'testuser@gmail.com', 'Approved', 'December/21/2020 10: 26: ', 'December/21/2020 13: 57: ');
...
INSERT INTO `propertyrequest` (`id`, `userID`, `propID`, `propName`, `price`, `contactNo`, `contactEmail`, `requestDate`, `approvedDate`, `status`) VALUES
(1, 'Diasporana-468575239', '33', '2 Bedroom', '1,000.000.000.00', '080000000033', 'testuser@gmail.com', 'December-02-2020 16: 35: 30:', 'December-14-2020 16: 35: 30:', 'Approved'),
(11, 'Diasporana-468575239', '33', '2 Bedroom', '1,000.000.000.00', '080000000033', 'testuser@gmail.com', 'December-04-2020 08: 43: 36:', '', 'pending');
